...
@st.cache(allow_output_mutation=True)
def load_data3():
    data3_AT = pd.read_csv('ndf_AT.csv',index_col=0)
    data3_AU = pd.read_csv('ndf_AU.csv',index_col=0)
    data3_BR = pd.read_csv('ndf_BR.csv',index_col=0)
    data3_DE = pd.read_csv('ndf_DE.csv',index_col=0)
    data3_FR = pd.read_csv('ndf_FR.csv',index_col=0)
    data3_IT = pd.read_csv('ndf_IT.csv',index_col=0)
    data3_NZ = pd.read_csv('ndf_NZ.csv',index_col=0)
    data3_PL = pd.read_csv('ndf_PL.csv',index_col=0)
    data3_SE = pd.read_csv('ndf_SE.csv',index_col=0)
    data3_UK = pd.read_csv('ndf_UK.csv',index_col=0)
    data3_US = pd.read_csv('ndf_US.csv',index_col=0)
    data3 = pd.concat([data3_AT,data3_AU])
    data3 = pd.concat(data_3,data3_BR)
    data3 = pd.concat(data_3,data3_DE)
    data3 = pd.concat(data_3,data3_FR)
    data3 = pd.concat(data_3,data3_IT)
    data3 = pd.concat(data_3,data3_NZ)
    data3 = pd.concat(data_3,data3_PL)
    data3 = pd.concat(data_3,data3_SE)
    data3 = pd.concat(data_3,data3_UK)
    data3 = pd.concat(data_3,data3_US)
...
def load_data1(Col_Select):
    ...
    data1_DE = pd.read_csv('df_DE.csv',index_col=0)
    data1_FR = pd.read_csv('df_FR.csv',index_col=0)
    data1_IT = pd.read_csv('df_IT.csv',index_col=0)
    data1_NZ = pd.read_csv('df_NZ.csv',index_col=0)
    data1_PL = pd.read_csv('df_PL.csv',index_col=0)
    data1_SE = pd.read_csv('df_SE.csv',index_col=0)
    data1_UK = pd.read_csv('df_UK.csv',index_col=0)
    data1_US = pd.read_csv('df_US.csv',index_col=0)
